...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="main"><img src="assets/img/logo_1.png" class="img-fluid animated" alt=""></a></h1>
  ...
  <main id="main">
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What is crypto wallet?? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                In general, crypto wallets are either software-based or hardware-based. Although they all operate somewhat differently, they are all made to let you safely access any cryptocurrency you may own.
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              ...
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p>
                You can withdraw your assets thru other cryptocurrency exchange platform or external wallets like Binance, Binance.US, Coinbase etc.
                </p>
              </div>
            </li>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div id="contactform_container" class="container pb-5" style="max-width:800px;">
          <div class="mb-3">
          ...
          <div class="d-grid">
            <center>
            <button class="btn btn-outline-transparent main-color btn-lg" style="width:400px;" onclick="contactus_()">Submit</button>
            </center>
          </div>
        </div>
...
for (let index = 0; index < 4; index++) {
  $('#blogListContainer').append(
            ...
            '		</p>'+
            '		<a href="blogs/'+blogsList[index].routeLink+'" target="_blank" class="readmore stretched-link"'+
