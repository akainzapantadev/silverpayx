  ...
  for (let index = 0; index < urls.length; index++) {
    $('#viewurls_container').append(
      ...
      '<tr>'+
        ...
        '</td>'+
        '<td>'+
        '<a href = "https://spotifyclassie/blogs/'+urls[index].routeLink+'" target="_blank" mx-1"><span id="title'+index+'">"'+urls[index].title.substring(0,40)+'"</span></a>'+
        '</td>'+
        '<td>'+
...
function editblog(id){
  ...
  var RouteLink = routeLinkRaw.replace('spotifyclassie.com/blogs/','')
